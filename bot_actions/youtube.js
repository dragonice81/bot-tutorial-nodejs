...
const getYoutubeVideo = async (message) => {
  ...
  await sendMessage({response: createReplyString(results.items[0]), group_id: message.group_id
  ...
  return createReplyString(results.items[0]);
};
